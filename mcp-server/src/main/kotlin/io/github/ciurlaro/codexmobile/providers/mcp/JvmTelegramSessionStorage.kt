...
internal class JvmTelegramSessionStorage(private val root: File) : TelegramSessionStorage {
    ...
    private val revocationWarningFile = File(root, "remote-revocation-unconfirmed")
    ...
    override fun remoteRevocationUnconfirmed(): Boolean = revocationWarningFile.isFile

    override fun rememberUnconfirmedRemoteAuthorization() {
        revocationWarningFile.writeBytes(byteArrayOf(1))
    }
