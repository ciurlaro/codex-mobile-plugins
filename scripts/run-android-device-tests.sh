...
documents=$(find "$artifacts" -type f -name provider_documents-debug.apk -print -quit)
documents_test=$(find "$artifacts" -type f -name documents-android-debug-androidTest.apk -print -quit)
telegram=$(find "$artifacts" -type f -name provider_telegram-debug.apk -print -quit)
telegram_test=$(find "$artifacts" -type f -name telegram-android-debug-androidTest.apk -print -quit)
test -f "$documents" && test -f "$documents_test"
test -f "$telegram" && test -f "$telegram_test"
