...
internal class TdLibSession(
    ...
    private fun tdlibParameters() = JSONObject()
        ...
        .put("device_model", clientInfo.deviceModel.take(64))
        .put("system_version", clientInfo.systemVersion.take(32))
        .put("application_version", clientInfo.applicationVersion.take(64))
